...
Cada día, y dependiendo de su ánimo y energía, Juan Paul construye una lista indicando hasta qué pendiente 
máxima está dispuesto a 
%enfrentar 
subir 
con cada cambio. 
...
indica la pendiente máxima que puede 
%enfrentar 
subir
con el cambio $1$, el segundo la pendiente máxima que puede 
%enfrentar 
subir
con el cambio $2$, y así sucesivamente.
...
donde $g_1$ indica la pendiente máxima que Juan Paul puede subir con el cambio $1$,
$g_2$ la pendiente máxima que puede subir con el cambio $2$, etc.
