...
cómodo al pedalear. 
Un cambio más bajo implica un menor esfuerzo para enfrentar una pendiente pronunciada, 
pero también implica que va más lento.
Por el contrario, un cambio más alto le permite ir a más velocidad pero no enfrentar
...
Cada día Juan Paul construye una lista indicando hasta qué pendiente 
máxima está dispuesto a enfrentar con cada cambio. 
La lista es una secuencia de números entre $0$ (que representa $0$ grados) 
y $90\,000$ (que representa $90$ grados), ordenados de mayor a menor. El primero de estos números 
indica la pendiente máxima que puede enfrentar con el cambio $1$, el segundo la pendiente máxima que
puede enfrentar con el cambio $2$, y así sucesivamente.
...
siempre usará el cambio más alto que le permite enfrentar
...
En este caso, para el primer tramo $P_1$ de pendiente $3000$, Juan Paul puede usar el cambio $4$, 
el más rápido.
Por el contrario, para el segundo tramo $P_2=42 000$, necesita usar el cambio $1$, el más bajo. 
Y así sucesivamente, para el tramo $P_3=15 000$ debe usar el cambio $3$, para el tramo $P_4=42 000$
debe usar el cambio $1$, para el tramo $P_5=0$ debe usar el cambio $4$ y para el tramo $P_6=25 000$ debe usar
el cambio $2$.
...
la lista que indica hasta qué pendiente máxima Juan puede enfrentar con cada cambio,
...
La siguiente línea contiene $N$ enteros $g_1,g_2,\ldots, g_N$, todos entre $0$ y $90\,000$, 
donde $g_1$ indica la pendiente máxima que Juan Paul puede enfrentar con el cambio $1$,
$g_2$ la pendiente máxima que puede enfrentar con el cambio $2$, etc.

La tercera línea contiene $T$ enteros $p_1,p_2,\ldots,p_T$, todos entre $0$ y $90\,000$, 
donde $p_1$ es la pendiente del tramo $1$ del camino que se debe subir, $p_2$ es la pendiente
del tramo $2$, etc.
...
la línea $2$ el cambio que se debe usar para la pendiente $p_2$, la línea $3$ el cambio que se debe usar 
